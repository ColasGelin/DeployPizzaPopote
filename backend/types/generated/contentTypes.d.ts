...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DateAndPlace: Schema.Attribute.String;
    Description: Schema.Attribute.String;
...
export interface ApiTeamContentTeamContent extends Struct.CollectionTypeSchema {
  collectionName: 'team_contents';
  info: {
    displayName: 'Team Content';
    pluralName: 'team-contents';
    singularName: 'team-content';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    imageLeft: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    imageRight: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::team-content.team-content'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::team-content.team-content': ApiTeamContentTeamContent;
